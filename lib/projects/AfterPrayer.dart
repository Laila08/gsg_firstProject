...
class AfterPrayer extends StatefulWidget {
  @override
  State<AfterPrayer> createState() => _AfterPrayerState();
}
class _AfterPrayerState extends State<AfterPrayer> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: MuslimTitleWidget(title:'أذكار بعد الصلاة'),
